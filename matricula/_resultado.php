...
function  Confirma_Exclusao(ano,aluno,turma,disciplina,nome_turma){
	if(confirm("Confirma a exclusão deste Registro?"))
		window.location = 'excluir_registro_matricula.php?ano='+ano+'&aluno='+aluno+'&turma='+turma+'&disciplina='+disciplina+'&nome_turma='+nome_turma;
	}
</script>
</head>
<body>
