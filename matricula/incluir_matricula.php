	...
	<table width="100%" height="95%" align="center" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			  <form name="form_matricula" method="get" action="matricular.php">
			  <input type="hidden" name="ano" value="<?php print(date('Y')); ?>">
				<tr>
				  ...
				  ?>
				  	<option value="<?php print($reg_turma['Turma']); ?>|<?php print($reg_turma['Nome']); ?>|<?php print($reg_turma['Curso']); ?>|<?php print($reg_turma['Ano']); ?>"><?php print($reg_turma['Turma']); ?>|<?php print($reg_turma['Nome']); ?></option>
				  <?php
					}
				  ?>
				  </select>
