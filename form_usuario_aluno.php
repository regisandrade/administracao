...
<script language="JavaScript" type="text/javascript">
	function visualizarItem(valor){
		if(valor == 'T'){
			mostrarTurma.style.display = "block";
			mostrarAluno.style.display = "none";
		}else{
			mostrarTurma.style.display = "none";
			mostrarAluno.style.display = "block";
		}
	}
  ...
  <tr>
	...
	<table width="100%" height="95%" align="center" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		...
		<tr>
			...
			<form name="form_matricula" method="post" action="usuario_aluno.php">
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				  ...
				  ?>
				  	<option value="<?=$reg_turma['Turma']."|".$reg_turma['Ano']?>"><?php print($reg_turma['Turma']); ?>|<?php print($reg_turma['Nome']); ?></option>
				  <?php
					}
				  ?>
				  </select>
