...
$result = mysql_query($comando) or die ("<font face='Verdana' size='2'>Erro na Consulta dos Currículos.</font>");
...
function  Confirma_Exclusao(codg,nome){
	if(confirm("Confirma a exclusão deste Currículo?"))
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<table width="100%" height="95%" align="center" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		<tr>
			<td colspan="2" valign="top" height="25"><div id="pageName" style="font-family:Verdana"><h3>Consulta de Currículo</h3></div></td>
		</tr>
		<tr>
			...
			<td colspan="2" valign="top">
			  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
				  ...
				  <td align="center" bgcolor="#EEEEEE" class="Texto" style="padding-left: 0.3em"><b>Titulação</b></td>
				  <td align="center" bgcolor="#EEEEEE" class="Texto" style="padding-left: 0.3em"><b>PUC</b></td>
				  <td align="center" bgcolor="#EEEEEE" class="Texto" style="padding-left: 0.3em"><b>Endereço Lattes</b></td>
