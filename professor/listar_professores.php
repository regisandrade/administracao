...
if(!empty($_REQUEST['descricao'])){
	$comando .= " AND TP.Nome LIKE '%".$_REQUEST['descricao']."%'";
}
$comando .= "
ORDER BY
	TP.Nome";
	...
	<table width="100%" height="95%" align="center" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="3">
				<tr>
					<td colspan="6" height="15" align="right" class="Texto" style="padding-right: 0.3em"><a href="JavaScript:history.back();"><< VOLTAR</a></td>
				</tr>
				<tr>
					<td width="10%" height="15" align="left" bgcolor="#EEEEEE" class="Texto" style="padding-left: 0.3em"><b>CPF</b></td>
					<td width="40%" align="left" bgcolor="#EEEEEE" class="Texto" style="padding-left: 0.3em"><b>Nome</b></td>
					...
					<td width="5%" align="center" bgcolor="#EEEEEE" class="Texto" style="padding-left: 0.3em; padding-right: 0.3em"><b>Opções</b></td>
				</tr>
				<?php
				if($num < 1){
				?>
				...
				<tr bgcolor="<?php print($cor); ?>">
					<td height="15" align="left" class="Texto" style="padding-left: 0.3em"><?php print($registro['Id_Numero']); ?></td>
			...
			?>
			<form name="frmBuscar" action="listar_professores.php" method="post">
			<table width="80%" border="0" cellpadding="0" cellspacing="3">
				<tr>
					<td width="8%" class="Texto">Nome:</td>
					<td width="92%"><input type="text" name="descricao" id="descricao" size="35" class="TextoFormulario" /></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td><input type="submit" name="buscar" value="Buscar" class="TextoFormulario" /></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td class="Texto" style="color: #FF0000">Obs.: Para selecionar todos os professores, click no botão Buscar.</td>
				</tr>
			</table>
			</form>
			<?php
