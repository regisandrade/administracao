...
// Consultar Turmas
$cmd_turma = "SELECT DISTINCT Turma, Nome, Ano FROM turma ORDER BY Turma, Nome";
  ...
  <tr>
	...
	<table width="100%" height="95%" align="center" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		...
		<tr>
			...
			<form action="selCursoResultado.php" method="post">
			  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
				  ...
				  ?>
				  	<option value="<?php print($reg_turma['Turma']); ?>|<?php print($reg_turma['Nome']); ?>|<?php print($reg_turma['Ano']); ?>"><?php print($reg_turma['Turma']); ?>|<?php print($reg_turma['Nome']); ?></option>
				  <?php
					}
				  ?>
				  </select>
