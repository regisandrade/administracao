...
$sql = "SELECT DISTINCT A.Id_Numero, A.Nome
	FROM
		aluno A
	INNER JOIN alunos_academicos AC ON 
		AC.Aluno = A.Id_Numero
	WHERE
		  A.Ano      = '".$ano_turma."'
	  AND A.situacao = 1
...
function visualizar(codAluno,nomeAluno,largura,altura){
	...
	window.open('visualizarNotaPdf.php?turma=<?=$codg_turma?>&idAluno='+codAluno+'&nomeAluno='+nomeAluno,'Notas',propriedades);
}
	...
	<table width="100%" height="95%" align="center" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		<tr>
		  <td height="25" colspan="2" valign="top"><div id="pageName" style="font-family:Verdana">
			<h3>Consulta de Notas &amp; Frequ&ecirc;ncias por Aluno</h3>
		  </div></td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2" valign="top">
			  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				<tr>
				  <td width="22%" height="15" align="right" class="Texto" style="padding-left: 0.3em">Turma:</td>
				  <td width="78%" class="Texto" style="padding-left: 0.3em"><b><?php print($codg_turma); ?></b></td>
				</tr>
				<tr>
				  <td width="22%" height="15" align="right" class="Texto" style="padding-left: 0.3em">Curso:</td>
				...
				<table width="100%" border="0" align="center" cellpadding="0" cellspacing="3">
					<tr style="background-color: #DDD; height: 17px">
						<th class="Texto" style="width: 80%">Aluno</th>
						<th class="Texto" style="width: 20%">Visualizar Nota</th>
					</tr>
					<?php
					if($numero == 0){
					?>
					...
					<tr style="height: 17px;" onMouseOut="mOut(this,'FFFFFF')" onMouseOver="mOvr(this,'DEDEDE')">
						...
						<td class="Texto" style="width: 15%; border: solid 1px #DDD; text-align: center"><a href="visualizarNotaPdf.php?turma=<?php echo $codg_turma ?>&nomeTurma=<?php echo $nome_turma; ?>&idAluno=<?php echo $dados['Id_Numero']; ?>&nomeAluno=<?php echo $dados['Nome']; ?>" target="_blank">[Aqui]</a></td>
					</tr>
					<?php
						}
					}
