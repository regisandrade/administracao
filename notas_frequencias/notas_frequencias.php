...
$cmd_disciplinas = "SELECT DISTINCT
                    ...
                    ORDER BY
                          DIS.Nome";
$res_disciplinas = mysql_query($cmd_disciplinas) or die('Erro na consulta das Disciplinas. '.mysql_error());
...
function Verificar(nForm){
	...
	pagina = "gride_nota_frequencia.php?ano="+ano+"&turma="+turma+"&disciplina="+disciplina+"&curso="+curso;
	gride_notas_frequencia.location = pagina;
  ...
  <tr>
	...
	<table width="100%" height="95%" align="center" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		...
		<tr>
			...
			<input type="hidden" name="curso" value="<?php print($codgCurso); ?>">
			  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				<tr>
				  <td colspan="2" class="Texto" style="padding-left: 0.3em"><iframe name="gride_notas_frequencia" width="100%" height="300" frameborder="0" src="gride_nota_frequencia.php"></iframe></td>
			    </tr>
			  </table>
			</form>
			</td>
