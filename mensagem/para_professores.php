	...
	<table width="100%" height="95%" align="center" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		...
		<tr>
		  ...
		  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			<form name="form_mail" method="post" action="mail_professor.php" onSubmit="return Verificar()">
			  <tr align="center"> 
			  ...
			  <tr> 
				<td width="18%" align="right" valign="top" class="Texto" style="padding-left: 0.3em">Professor :</td>
				<td width="82%" style="padding-left: 0.3em"><?php
				//== Selecionar Professores
				if($_GET['professor'] == 1){
					print('<input name="para" type="text" class="TextoFormulario" size="45" value="TODOS PROFESSORES" readonly="true">');
				}else{
					// Desmembrano a variavel para
					$tipo_prof = explode('|',$_GET['professor']);
					$codg_prof = $tipo_prof[0];
					$nome_prof = $tipo_prof[1];
					print('<input name="para" type="hidden" class="TextoFormulario" size="45" value="'.$codg_prof.'" readonly="true">');
					print('<input name="nome_para" type="text" class="TextoFormulario" size="45" value="'.$nome_prof.'" readonly="true">');
				}
				?></td>
			  </tr>
			  <tr>
