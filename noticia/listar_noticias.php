...
function  Confirma_Exclusao(codg)
	...
	if(confirm("Confirma a exclusão desta Notícia?"))
		window.location = 'excluir_noticia.php?codg_noticia='+ codg;
	}
</script>
<style type="text/css">
<!--
	...
	<table width="100%" height="95%" align="center" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		<tr>
			<td colspan="2" valign="top" height="25"><div id="pageName" style="font-family:Verdana">
			  <h3>Consulta de Not&iacute;cias </h3>
			</div></td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2" valign="top">
				<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
					<tr> 
						<td width="30%" height="15" align="left" bgcolor="#EEEEEE" class="Texto" style="padding-left: 0.3em"><b>Título</b></td>
						<td width="45%" align="left" bgcolor="#EEEEEE" class="Texto" style="padding-left: 0.3em"><b>Notícia</b></td>
						<td width="15%" align="left" bgcolor="#EEEEEE" class="Texto" style="padding-left: 0.3em"><b>Data</b></td>
					...
					<tr bgcolor="<?php print($cor); ?>">
						...
						<td align="left" class="Texto" style="padding-left: 0.3em"><?php print($registro['Data']); ?></td>
						<td align="center" class="Texto" style="padding-left: 0.3em; padding-right: 0.3em"><a href="alterar_noticia.php?codg_noticia=<?php print($registro['Codg_Noticia']); ?>"><img src="../../imagens/alterar.gif" border="0" title="Alterar"></a>&nbsp;|&nbsp;<a href="#" onClick="Confirma_Exclusao(<?php print($registro['Codg_Noticia']); ?>)"><img src="../../imagens/excluir.gif" border="0" title="Excluir"></a></td>
					</tr>
					<?php
							$conta++;
						}
